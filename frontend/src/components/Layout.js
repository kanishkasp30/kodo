...
{ label: '✦ AI Assistant', icon: '', section: 'ai' },
        ...
        <div style={{ padding: '10px', borderTop: `0.5px solid ${theme.cardBorder}` }}>
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  background: t.color,
                  border: themeName === t.key ? `3px solid ${t.border}` : `1.5px solid ${theme.cardBorder}`,
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '6px 8px', borderRadius: '8px', background: theme.card, border: `0.5px solid ${theme.cardBorder}` }}>
            ...
            <div onClick={logoutUser} style={{ fontSize: '16px', cursor: 'pointer', color: theme.textMuted }} title="Logout">🚪</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <div style={{
          height: '52px', background: theme.topbar,
